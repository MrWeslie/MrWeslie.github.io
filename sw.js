...
self.__precacheManifest = [
  {
    "url": "webpack-runtime-8068f65bad7d2bb8daf5.js"
  },
  {
    "url": "app-db48846d7f4e2bb6c561.js"
  },
  {
    "url": "component---node-modules-gatsby-plugin-offline-app-shell-js-e55c3d9aa07024181a49.js"
  },
  {
    "url": "offline-plugin-app-shell-fallback/index.html",
    "revision": "03b8468038b5654a7afb0c4300e72ba4"
  },
  {
    "url": "0.143da63e59bcd748525e.css"
  },
  {
    "url": "0-a0baa328d2b219c54380.js"
  },
  {
    "url": "component---src-pages-404-js-4aafaffb72c13563b594.js"
  },
  {
...
var navigationRoute = new workbox.routing.NavigationRoute(function (_ref) {
  ...
  return idbKeyval.get(WHITELIST_KEY).then(function (customWhitelist) {
    ...
    if (customWhitelist.includes(pathname)) {
      var offlineShell = "/MrWeslie.github.io/offline-plugin-app-shell-fallback/index.html";
...
var messageApi = {
  whitelistPathnames: function whitelistPathnames(event) {
    ...
    pathnames = pathnames.map(function (_ref3) {
      ...
      if (!includesPrefix) {
        return "/MrWeslie.github.io" + pathname;
      } else {
        return pathname;
      }
    });
